...
VendingMachine.items = db.relationship("Item", order_by=Item.id, back_populates="vending_machine") # Create a relationship between the VendingMachine and Item models
