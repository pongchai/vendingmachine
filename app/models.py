"""
Module containing the VendingMachine and Item models for the vending machine application.

This module uses Flask-SQLAlchemy to create and manage the database.
"""
...
VendingMachine.items = db.relationship(
    "Item", order_by=Item.id, back_populates="vending_machine"
)  # Create a relationship between the VendingMachine and Item models
